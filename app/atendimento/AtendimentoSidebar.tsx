...
const NAV = [
  ...
  { href: "/atendimento/pedidos/novo", label: "Novo pedido" },
];

export function AtendimentoSidebar({ orgNome, nome }: { orgNome: string; nome?: string }) {
  ...
  return (
    <>
      <div className="flex shrink-0 items-center justify-between border-b border-neutral-800 bg-neutral-950 px-4 py-3 text-white md:hidden">
        ...
        <span className="text-sm font-bold">nexIA · Atendimento</span>
